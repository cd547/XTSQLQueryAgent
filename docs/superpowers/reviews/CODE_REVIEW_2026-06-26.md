...
> | 🟡 P2 中等 Bug | 3/3 | 0 | 2 ⏸️ | BUG-7、BUG-9、BUG-11 已修；BUG-8、BUG-10 不修 |
...
> | 🟡 P2 本轮新发现 | 3/3 | 0 | 0 | NEW-2、NEW-5、NEW-6 |
> | 🟢 P3 本轮新发现 | 2/2 | 0 | 0 | NEW-3、NEW-4 |
> | **合计** | **22/29 (75.9%)** | **7** | **4** | 含 ⏸️ 不修/暂缓 4 项时为 **22/33 (66.7%)** |
>
...
6. **后续迭代（持续优化）**: P3 剩余 **7 项**（PERF-1/2/6、SEC-2、CODE-1/4/5）；另有 PERF-3 暂不实施（无长会话场景反馈）
