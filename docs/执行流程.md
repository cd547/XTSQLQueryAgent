...
| 6 | [query.js:405](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/routes/query.js#L405) | `generator = runSqlAgent(...)`（F16 重命名，原名 `generateSQLWithLangChainStreamGen_BAK`）|
| 7 | [query.js:407-470](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/routes/query.js#L407-L470) | `for await (chunk of generator)` 消费 yield，分发 SSE 事件 + 同步入库 |
...
主函数：`runSqlAgent` ([llm.js:1079-2026](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js#L1079-L2026))（F16 重命名，原名 `generateSQLWithLangChainStreamGen_BAK`，见 [llm.js:1067-1078](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js#L1067-L1078) 注释）
...
**排查**：
1. 确认 `resetPerQuestionRegistryFlags` 在 `runSqlAgent` 入口被调用
...
| [services/llm.js](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js) | LLM 主循环 | `runSqlAgent` [L1079](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js#L1079)（原名 `generateSQLWithLangChainStreamGen_BAK`）|
| | | 工具剪枝 [L1285](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js#L1285) |
| | | 三阶段执行 [L1585](file:///d:/Ai_Program_Files/XTSQLQueryAgent/backend/src/services/llm.js#L1585) |
