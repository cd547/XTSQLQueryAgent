...
| `services/validators.js` | `validate_sql_fields` 工具实现：R1/R2/R3/R5 四类静态规则 + R6 EXPLAIN 真实库对账（2026-08-31） | `validateSqlFields` |
...
| Electron 启动日志 | `logs/electron-startup-<年-月>.log`（按月归档，追加写） | 壳启动、端口处理、后端子进程 stdout/stderr |
