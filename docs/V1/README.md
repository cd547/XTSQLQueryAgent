...
1. 每次涉及核心流程（Agent 循环、SSE 协议、工具集、DB schema、API）的代码变更，请同步更新 `01~04` 对应文档。
2. 新增/修复问题请登记到 [06-问题清单.md](./06-问题清单.md)，标注状态与验证方式。
3. 新增工具或模块请按 [07-开发指南.md](./07-开发指南.md) 的“代码地图”和扩展点执行，并更新功能-代码映射表。
4. 所有文件使用 **UTF-8（无 BOM）** 编码，中文正文；`docs/V1` 内使用相对链接。
