CREATE TABLE `customer_contact` (
  ...
  `people_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '联系人ID 关联表 customer_people id , 0 表示本人手机号',
  `customer_code` varchar(20) NOT NULL COMMENT '线索编码',
  `concat_type` int(11) NOT NULL COMMENT '联系类型(0-手机号/1-微信号/2-邮箱)',
  `area_code` varchar(4) NOT NULL DEFAULT '+86' COMMENT '区号',
  `concat` varchar(40) NOT NULL DEFAULT '0' COMMENT '联系方式',
  ...
  KEY `idx_concat` (`concat`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=110216 DEFAULT CHARSET=utf8mb4 COMMENT='线索联系方式表'