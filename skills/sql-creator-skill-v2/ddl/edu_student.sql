CREATE TABLE `edu_student` (
  ...
  `type` int(11) NOT NULL DEFAULT '1' COMMENT '类型1学通学生2客户3科桥学生',
  ...
  `bank_account_status` int(11) NOT NULL DEFAULT '0' COMMENT '银行账号是否注销；0-初始化；1-有效；2-注销',
  ...
  `stu_height` int(5) DEFAULT NULL COMMENT '身高(厘米*10)，如175.5cm存为1755',
  `stu_weight` int(5) DEFAULT NULL COMMENT '体重(公斤*10)，如65.5kg存为655',
  `application_season` varchar(50) DEFAULT NULL COMMENT '申请季',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `edu_student_ibfk_4` FOREIGN KEY (`edu_student_status_id`) REFERENCES `edu_student_status` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
